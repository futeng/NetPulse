...
<p align="center">
  <img src="docs/images/netpulse-mascot.png" width="220" alt="NetPulse 旗鱼标志">
</p>

![NetPulse 主面板](docs/images/netpulse-dashboard.png)

<p align="center">
  <img src="docs/images/netpulse-menubar.png" width="360" alt="NetPulse 菜单栏状态">
</p>
...
NetPulse 使用以游速见长、轮廓鲜明的旗鱼作为默认品牌形象。长吻、高帆状背鳍和新月尾在菜单栏小尺寸下仍然清晰；游速直接对应当前网络体验，主界面和菜单栏保持同一套视觉语言。用户也可以切换其他观赏鱼形象。
